...
function DataTableRowComponent_ng_template_7_th_0_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("textContent", ctx_r5.item[column_r2.property]);
} }
...
function DataTableRowComponent_ng_template_7_th_0_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngTemplateOutlet", column_r2.cellTemplate)("ngTemplateOutletContext", ɵɵpureFunction3(2, _c1$1, column_r2, ctx_r6._this, ctx_r6.item));
} }
function DataTableRowComponent_ng_template_7_th_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵstyleProp("background-color", column_r2.getCellColor(ctx_r3._this, ctx_r3.index));
...
function DataTableRowComponent_ng_template_7_td_1_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("textContent", ctx_r10.item[column_r2.property]);
} }
function DataTableRowComponent_ng_template_7_td_1_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngTemplateOutlet", column_r2.cellTemplate)("ngTemplateOutletContext", ɵɵpureFunction3(2, _c1$1, column_r2, ctx_r11._this, ctx_r11.item));
} }
function DataTableRowComponent_ng_template_7_td_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵstyleProp("background-color", column_r2.getCellColor(ctx_r4._this, ctx_r4.index));
    ɵɵproperty("hide", !column_r2.visible)("ngClass", column_r2.styleClassObject);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", !column_r2.cellTemplate);
    ɵɵadvance(1);
...
function DataTableRowComponent_ng_template_7_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngIf", ctx_r0.dataTable.primaryColumn === column_r2.property);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r0.dataTable.primaryColumn !== column_r2.property);
} }
...
function DataTablePaginationComponent_option_9_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("value", l_r2);
    ɵɵadvance(1);
    ɵɵtextInterpolate(l_r2);
} }
let nextId = 0;
...
DataTablePaginationComponent.ɵcmp = ɵɵdefineComponent({ type: DataTablePaginationComponent, selectors: [["data-table-pagination"]], viewQuery: function DataTablePaginationComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("click", function DataTablePaginationComponent_Template_button_click_13_listener() { return ctx.pageFirst(); });
        ɵɵelement(14, "i", 12);
        ɵɵelementStart(15, "span", 13);
        ɵɵtext(16, "first page");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(17, "button", 14);
        ɵɵlistener("click", function DataTablePaginationComponent_Template_button_click_17_listener() { return ctx.pageBack(); });
        ɵɵelement(18, "i", 15);
        ɵɵelementStart(19, "span", 13);
        ɵɵtext(20, "previous page");
        ɵɵelementEnd();
        ɵɵelementEnd();
        ...
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵelementStart(24, "input", 18, 19);
        ɵɵlistener("blur", function DataTablePaginationComponent_Template_input_blur_24_listener($event) { return ctx.validate($event); })("keyup.enter", function DataTablePaginationComponent_Template_input_keyup_enter_24_listener($event) { return ctx.validate($event); })("keyup.esc", function DataTablePaginationComponent_Template_input_keyup_esc_24_listener() { ɵɵrestoreView(_r3); const _r1 = ɵɵreference(25); return _r1.value = ctx.page; });
        ɵɵelementEnd();
        ...
        ɵɵlistener("click", function DataTablePaginationComponent_Template_button_click_29_listener() { return ctx.pageForward(); });
        ɵɵelement(30, "i", 22);
        ...
        ɵɵlistener("click", function DataTablePaginationComponent_Template_button_click_33_listener() { return ctx.pageLast(); });
        ɵɵelement(34, "i", 24);
...
function DataTableComponent_th_19_button_3_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("id", "col-" + ctx_r13.id + "-" + i_r8)("ngTemplateOutlet", column_r7.headerTemplate)("ngTemplateOutletContext", ɵɵpureFunction1(3, _c1$2, column_r7));
} }
...
function DataTableComponent_th_19_button_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("click", function DataTableComponent_th_19_button_3_Template_button_click_0_listener($event) { ɵɵrestoreView(_r24); const column_r7 = ɵɵnextContext().$implicit; const ctx_r22 = ɵɵnextContext(); return ctx_r22.headerClicked(column_r7, $event); });
    ɵɵtemplate(1, DataTableComponent_th_19_button_3_span_1_Template, 1, 2, "span", 21);
    ɵɵtemplate(2, DataTableComponent_th_19_button_3_span_2_Template, 1, 5, "span", 22);
    ɵɵtemplate(3, DataTableComponent_th_19_button_3_span_3_Template, 3, 6, "span", 23);
    ɵɵtemplate(4, DataTableComponent_th_19_button_3_span_4_Template, 1, 0, "span", 24);
    ɵɵelementEnd();
} if (rf & 2) {
...
function DataTableComponent_th_19_span_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵtemplate(1, DataTableComponent_th_19_span_4_span_1_Template, 1, 1, "span", 31);
    ɵɵtemplate(2, DataTableComponent_th_19_span_4_span_2_Template, 1, 4, "span", 32);
    ɵɵtemplate(3, DataTableComponent_th_19_span_4_span_3_Template, 3, 6, "span", 23);
    ɵɵtemplate(4, DataTableComponent_th_19_span_4_span_4_Template, 1, 0, "span", 24);
    ɵɵelementEnd();
} if (rf & 2) {
...
function DataTableComponent_th_19_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "th", 17, 18);
    ɵɵpipe(2, "px");
    ɵɵtemplate(3, DataTableComponent_th_19_button_3_Template, 5, 8, "button", 19);
    ɵɵtemplate(4, DataTableComponent_th_19_span_4_Template, 5, 4, "span", 3);
    ɵɵelementEnd();
} if (rf & 2) {
...
function DataTableComponent_tbody_20_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(0, "tbody", 34, 35);
    ɵɵlistener("selectedChange", function DataTableComponent_tbody_20_Template_tbody_selectedChange_0_listener() { ɵɵrestoreView(_r41); const _r39 = ɵɵreference(1); const ctx_r40 = ɵɵnextContext(); return ctx_r40.onRowSelectChanged(_r39); });
    ɵɵelementEnd();
} if (rf & 2) {
...
function DataTableComponent_tbody_22_tr_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelement(1, "td", 39);
    ɵɵelementStart(2, "td", 39);
    ɵɵtext(3, "\u00A0");
    ɵɵelementEnd();
    ɵɵelement(4, "td", 39);
    ɵɵtemplate(5, DataTableComponent_tbody_22_tr_1_td_5_Template, 1, 1, "td", 40);
    ɵɵelementEnd();
} if (rf & 2) {
...
function DataTableComponent_tbody_22_Template(rf, ctx) { if (rf & 1) {
    ɵɵelementStart(0, "tbody", 36);
    ɵɵtemplate(1, DataTableComponent_tbody_22_tr_1_Template, 6, 8, "tr", 37);
    ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r4 = ɵɵnextContext();
    ɵɵadvance(1);
...
function DataTableComponent_data_table_pagination_24_Template(rf, ctx) { if (rf & 1) {
    ɵɵelement(0, "data-table-pagination", 43);
} if (rf & 2) {
    const ctx_r6 = ɵɵnextContext();
...
DataTableComponent.ɵcmp = ɵɵdefineComponent({ type: DataTableComponent, selectors: [["data-table"]], contentQueries: function DataTableComponent_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ...
        ɵɵlistener("ngModelChange", function DataTableComponent_Template_input_ngModelChange_18_listener($event) { return ctx.selectAllCheckbox = $event; });
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtemplate(19, DataTableComponent_th_19_Template, 5, 13, "th", 12);
        ɵɵelementEnd();
        ɵɵelementEnd();
        ɵɵtemplate(20, DataTableComponent_tbody_20_Template, 2, 2, "tbody", 13);
        ɵɵtemplate(21, DataTableComponent_tbody_21_Template, 4, 2, "tbody", 3);
        ɵɵtemplate(22, DataTableComponent_tbody_22_Template, 2, 1, "tbody", 14);
        ɵɵelementEnd();
        ɵɵtemplate(23, DataTableComponent_div_23_Template, 3, 0, "div", 15);
        ɵɵelementEnd();
        ɵɵtemplate(24, DataTableComponent_data_table_pagination_24_Template, 1, 1, "data-table-pagination", 16);
        ɵɵelementEnd();
    } if (rf & 2) {
        ɵɵadvance(2);
        ...
        ɵɵadvance(1);
        ɵɵproperty("for", ctx.id + "-select-all-column");
        ɵɵadvance(1);
        ɵɵtextInterpolate1(" ", ctx.labels.selectAllRows, " ");
        ɵɵadvance(1);
        ɵɵproperty("id", ctx.id + "-select-all-column")("hide", !ctx.multiSelect)("ngModel", ctx.selectAllCheckbox)("disabled", ctx.itemCount === 0)("title", ctx.labels.selectAllRows);
        ɵɵadvance(1);
...
function DataTableHeaderComponent_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = ɵɵnextContext();
    ɵɵproperty("textContent", ctx_r0.dataTable.title);
} }
function DataTableHeaderComponent_div_12_li_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵlistener("ngModelChange", function DataTableHeaderComponent_div_12_li_2_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r7); const ctx_r6 = ɵɵnextContext(2); return ctx_r6.dataTable.expandColumnVisible = $event; })("change", function DataTableHeaderComponent_div_12_li_2_Template_input_change_2_listener($event) { ɵɵrestoreView(_r7); const ctx_r8 = ɵɵnextContext(2); return ctx_r8.onChange($event); });
    ɵɵelementEnd();
    ɵɵelement(3, "span", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngModel", ctx_r2.dataTable.expandColumnVisible);
    ɵɵattribute("aria-controls", ctx_r2.dataTable.id);
    ɵɵadvance(1);
    ɵɵproperty("textContent", ctx_r2.dataTable.labels.expandColumn);
} }
function DataTableHeaderComponent_div_12_li_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngModel", ctx_r3.dataTable.indexColumnVisible);
    ɵɵattribute("aria-controls", ctx_r3.dataTable.id);
    ɵɵadvance(1);
    ɵɵproperty("textContent", ctx_r3.dataTable.labels.indexColumn);
} }
function DataTableHeaderComponent_div_12_li_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "label", 16);
    ɵɵelementStart(2, "input", 17);
    ɵɵlistener("ngModelChange", function DataTableHeaderComponent_div_12_li_4_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r13); const ctx_r12 = ɵɵnextContext(2); return ctx_r12.dataTable.selectColumnVisible = $event; })("change", function DataTableHeaderComponent_div_12_li_4_Template_input_change_2_listener($event) { ɵɵrestoreView(_r13); const ctx_r14 = ɵɵnextContext(2); return ctx_r14.onChange($event); });
    ɵɵelementEnd();
    ɵɵelement(3, "span", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    ɵɵadvance(2);
    ɵɵproperty("ngModel", ctx_r4.dataTable.selectColumnVisible);
    ɵɵattribute("aria-controls", ctx_r4.dataTable.id);
    ɵɵadvance(1);
    ɵɵproperty("textContent", ctx_r4.dataTable.labels.selectColumn);
} }
function DataTableHeaderComponent_div_12_ng_template_5_li_0_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵelementStart(1, "label", 16);
    ɵɵelementStart(2, "input", 17);
    ɵɵlistener("ngModelChange", function DataTableHeaderComponent_div_12_ng_template_5_li_0_Template_input_ngModelChange_2_listener($event) { ɵɵrestoreView(_r20); const item_r15 = ɵɵnextContext().$implicit; return item_r15.visible = $event; })("change", function DataTableHeaderComponent_div_12_ng_template_5_li_0_Template_input_change_2_listener($event) { ɵɵrestoreView(_r20); const ctx_r21 = ɵɵnextContext(3); return ctx_r21.onChange($event); });
    ɵɵelementEnd();
    ɵɵelement(3, "span", 18);
    ɵɵelementEnd();
    ɵɵelementEnd();
    ...
    const ctx_r17 = ɵɵnextContext(2);
    ɵɵadvance(2);
    ɵɵproperty("ngModel", item_r15.visible);
    ɵɵattribute("aria-controls", ctx_r17.dataTable.id);
    ɵɵadvance(1);
    ɵɵproperty("textContent", item_r15.header);
} }
function DataTableHeaderComponent_div_12_ng_template_5_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵɵproperty("ngIf", ctx_r5.dataTable.primaryColumn !== item_r15.property);
} }
function DataTableHeaderComponent_div_12_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r1 = ɵɵnextContext();
    ɵɵadvance(2);
    ɵɵproperty("ngIf", ctx_r1.dataTable.expandableRows);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r1.dataTable.indexColumn);
    ɵɵadvance(1);
    ɵɵproperty("ngIf", ctx_r1.dataTable.selectColumn);
    ɵɵadvance(1);
    ɵɵproperty("ngForOf", ctx_r1.dataTable.columns);
} }
...
DataTableHeaderComponent.ɵcmp = ɵɵdefineComponent({ type: DataTableHeaderComponent, selectors: [["data-table-header"]], hostBindings: function DataTableHeaderComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ...
        ɵɵlistener("click", function DataTableHeaderComponent_Template_button_click_3_listener() { return ctx.dataTable.reloadItems(); });
        ɵɵelement(4, "i", 4);
        ...
        ɵɵlistener("click", function DataTableHeaderComponent_Template_button_click_7_listener() { return ctx.columnSelectorOpen = !ctx.columnSelectorOpen; });
        ɵɵelement(8, "i", 7);
