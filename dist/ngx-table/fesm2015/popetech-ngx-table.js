import { Directive, ElementRef, Renderer2, Input, Pipe, ContentChild, EventEmitter, Component, Inject, forwardRef, Output, ContentChildren, ViewChildren, HostListener, ViewChild, NgModule } from '@angular/core';
