...
DataTableColumnDirective.ɵdir = /*@__PURE__*/ i0.ɵɵdefineDirective({ type: DataTableColumnDirective, selectors: [["data-table-column"]], contentQueries: function DataTableColumnDirective_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
...
DataTablePaginationComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataTablePaginationComponent, selectors: [["data-table-pagination"]], viewQuery: function DataTablePaginationComponent_Query(rf, ctx) {
        if (rf & 1) {
    ...
    }, directives: [i1$1.SelectControlValueAccessor, i1$1.NgControlStatus, i1$1.NgModel, i1.NgForOf, i1$1.NgSelectOption, i1$1.ɵNgSelectMultipleOption, i1$1.MinValidator, i1$1.MaxValidator, i1$1.NumberValueAccessor, i1$1.DefaultValueAccessor], styles: [".pagination-controllers[_ngcontent-%COMP%]   select[_ngcontent-%COMP%]{text-align:right}.pagination-box[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{outline:none!important}"] });
(function () {
...
DataTableComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataTableComponent, selectors: [["data-table"]], contentQueries: function DataTableComponent_ContentQueries(rf, ctx, dirIndex) {
        if (rf & 1) {
...
DataTableHeaderComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DataTableHeaderComponent, selectors: [["data-table-header"]], hostBindings: function DataTableHeaderComponent_HostBindings(rf, ctx) {
        if (rf & 1) {
